...
def server_experiment_args():
    ...
    args.version = 'baseline_ep25_bs32'
    args.train_batch_size = 32
...
if __name__ == '__main__':
    def experiment_one_round():
        ...
        todo_args.complete_path(
            ...
            specific_info=(
                todo_args.data_name, 
                todo_args.label_level,
                todo_args.task_name,
            )
        )
            
        Main().main_one_round(todo_args)
    
    def experiment_one_group():
        main = Main()
    ...
    experiment_one_round()
    # experiment_one_group()
    pass
